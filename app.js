 ...
 function getuser(){   
    ...
    socket.broadcast.emit('typing', {toUser:data.toUser,uname:data.username,mss: data.username + ' is typing...'});
     ...
     socket.on('message',data=>{
      // console.log(data);
        io.emit('message', {toUser:data.toUser,uname:data.username,mss:data.data});
...
function readchat(data){
    ...
    { 'to': data.toUser }
     ...
     io.emit('old-chats', {toUser:data.toUser,uname:data.username,result:result});
      // io.emit('old-chat', result);
       console.log("this is read data ....."+result)
